...
export declare enum IndexMeasure {
...
export type WrappedGenericMessageResponse = ResultsWrapper<GenericMessageResponse>;
...
export type WrappedCollectionsResponse = PaginatedResultsWrapper<CollectionResponse[]>;
export type WrappedCommunityResponse = ResultsWrapper<CommunityResponse>;
export type WrappedCommunitiesResponse = PaginatedResultsWrapper<CommunityResponse[]>;
export type WrappedConversationMessagesResponse = ResultsWrapper<MessageResponse[]>;
export type WrappedConversationResponse = PaginatedResultsWrapper<ConversationResponse>;
export type WrappedConversationsResponse = PaginatedResultsWrapper<ConversationResponse[]>;
export type WrappedMessageResponse = ResultsWrapper<MessageResponse>;
export type WrappedMessagesResponse = PaginatedResultsWrapper<MessageResponse[]>;
export type WrappedDocumentResponse = ResultsWrapper<DocumentResponse>;
export type WrappedDocumentsResponse = PaginatedResultsWrapper<DocumentResponse[]>;
...
export type WrappedRelationshipsResponse = PaginatedResultsWrapper<RelationshipResponse[]>;
