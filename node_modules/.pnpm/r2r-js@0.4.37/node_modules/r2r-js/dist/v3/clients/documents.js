...
class DocumentsClient {
    ...
    async create(options) {
        var _a, _b, _c;
        const inputCount = [options.file, options.raw_text, options.chunks].filter((x) => x !== undefined).length;
        if (inputCount === 0) {
    ...
    async list(options) {
        ...
        const params = {
            ...
            include_summary_embeddings: (_c = options === null || options === void 0 ? void 0 : options.includeSummaryEmbeddings) !== null && _c !== void 0 ? _c : false, // Added mapping to snake_case
        };
